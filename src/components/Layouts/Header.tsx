...
import { Flex, useColorModeValue, Spacer, Heading, Link, Popover, PopoverTrigger, PopoverContent, Text, Center, Divider } from '@chakra-ui/react'
  ...
  return (
    <Flex as="header" className={className} bg={useColorModeValue('gray.100', 'gray.900')} px={4} py={2} mb={8} alignItems="center">
      ...
      <Center>
          <Flex as="nav" >
          <Center w="100%">
            <Flex maxW="1200px" w="100%" alignItems="center">
              <Flex ml="auto">
